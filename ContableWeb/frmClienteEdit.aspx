...
<form runat="server" id="frmCuentaEdit" class="stdform" action="" method="post">
    ...
    <div id="tabs">
        ...
        <div id="tabs-1">
            ...
            <span class="field"><asp:DropDownList ID="cmbListaPrecios" runat="server"></asp:DropDownList></span>
            <label>Forma de Contacto</label>  
            <span class="field"><asp:DropDownList ID="cmbFormaContacto" runat="server"></asp:DropDownList></span>
