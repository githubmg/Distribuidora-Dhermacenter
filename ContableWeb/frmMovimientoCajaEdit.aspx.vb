...
Public Class frmMovimientoCajaEdit
    ...
    Private Sub cmdGuardar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdGuardar.Click
        If Me.ValidarFormulario() Then
            If Me.MovimientoCaja Is Nothing Then
                ...
                Me.MovimientoCaja.DescripcionMovCaja = Sistema.ObtenerDescripcionMovCaja(CType(cmbCategoria.SelectedValue, Integer))
                Me.MovimientoCaja.DescripcionMovimiento = txtDescripcionMovimiento.Text
    ...
    Private Sub CargarComboDescripcionMovCaja()
        Me.cmbCategoria.DataSource = Sistema.VistaDescripcionMovCaja
        Me.cmbCategoria.DataValueField = "idDescripcionMovCaja"
        Me.cmbCategoria.DataTextField = "descripcion"
