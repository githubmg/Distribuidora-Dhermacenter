...
<form runat="server" id="frmProductoEdit" class="stdform" action="" method="post">
    ...
    <div id="tabs">
        ...
        <div id="tabs-1">
            ...
            <span class="field"><asp:TextBox ID="txtCodProducto" runat="server" CssClass="smallinput" MaxLength="9"></asp:TextBox></span>
            <label>Familia</label>
            ...
            <label>Empresa</label>
            <span class="field"><asp:DropDownList ID="cmbEmrpesa" runat="server" ></asp:DropDownList></span>
            <label>Alícuota IVA</label>
             <span class="field"><asp:DropDownList ID="cmbAlicuotaIva" runat="server" ></asp:DropDownList></span>
        </div>
    </div>
    <br />
