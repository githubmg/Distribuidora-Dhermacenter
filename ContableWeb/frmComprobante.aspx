<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/ContableWeb.Master" CodeBehind="frmComprobante.aspx.vb" Inherits="ContableWeb.frmComprobante1" %>
...
<form runat="server" id="frmComprobante" class="">
   <asp:Button ID="cmdNuevo" runat="server" Text="Nuevo Comprobante" CssClass="stdbtn" /><br /><br />
    
    <div class="contenttitle radiusbottom0">
        <h2 class="table"><span>Comprobantes existentes</span></h2>
    </div><!--contenttitle-->
