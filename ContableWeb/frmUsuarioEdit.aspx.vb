...
Public Class frmUsuarioEdit
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Me.Request.QueryString("id") Is Nothing Then
            ...
            Me.Usuario = UsuarioBiz.getById(id)
        End If
    ...
    Private Function validarForm() As Boolean
        ...
        If Me.Usuario Is Nothing Then
            Dim uExistente As usuario = UsuarioBiz.getByNombreUsuario(txtNombreUsuario.Text)
