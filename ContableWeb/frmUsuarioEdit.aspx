...
<form runat="server" id="frmUsuarioEdit" class="stdform" action="" method="post">
    ...
    <div id="tabs">
        ...
        <div id="Div1">
            <label>Contraseña</label><span class="field"><asp:TextBox ID="txtContrasenia" runat="server" TextMode="Password"  CssClass="mediuminput" MaxLength="100"></asp:TextBox></span>
        </div>
        <div id="Div4">
            <label>Repetir contraseña</label><span class="field"><asp:TextBox ID="txtContrasenia2" runat="server" TextMode="Password" CssClass="mediuminput" MaxLength="100"></asp:TextBox></span>
        </div>
        <div id="Div2">
