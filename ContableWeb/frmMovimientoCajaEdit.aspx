...
<div class="contenttitle"><h2 class="form"><span>Movimiento de Caja</span></h2></div>
    ...
    <form runat="server" id="frmMovimientoCajaEdit" class="stdform" action="" method="post">
        ...
        <span class="field"><asp:DropDownList ID="cmbCategoria" runat="server" 
                AutoPostBack="True"></asp:DropDownList></span>
        <label>Descripción del Movimiento</label>
        <span class="field"><asp:TextBox ID="txtDescripcionMovimiento" runat="server" CssClass="mediuminput"></asp:TextBox></span>
        <label>Fecha</label>
