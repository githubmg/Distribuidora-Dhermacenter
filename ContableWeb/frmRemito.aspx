...
<script type="text/javascript">
    function guardarCheck(ch) {
        debugger;
        ch.setAttribute("checked", "true");
      
        var checkedValue = null;
        var inputElements = document.getElementsByClassName('chFacturar');
        var hid = document.getElementById('ctl00_contentCuerpo_hfSeleccionados');
        for (var i = 0; inputElements[i]; ++i) {
            if (inputElements[i].checked) {
                hid.value = hid.value + '$' + inputElements[i].value;
                break;
            }
        }
   ...
   <asp:Repeater ID="grilla" runat="server">
    ...
    <ItemTemplate>
            <tr class="">
                ...
                <td>
                    <asp:CheckBox ID="chkFacturar" runat="server"  OnCheckedChanged="Check_Changed" AutoPostBack="true" class= "chFacturar" Value ='<%#DataBinder.Eval(Container.DataItem, "idRemito")%>'/>
