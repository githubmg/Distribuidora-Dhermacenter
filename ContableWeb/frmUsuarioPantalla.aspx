                    ...
                    <asp:Repeater ID="grilla" runat="server" >
                        ...
                        <ItemTemplate>
                            <tr class="">
                                ...
                                <td><%# Utiles.BooleanAString(DataBinder.Eval(Container.DataItem,"esPantallaPrincipal"))%></td>
                                <td>
                                <asp:LinkButton id="lnkDelete" CommandName="Borrar" CommandArgument='<%# DataBinder.Eval(Container.DataItem,"idPantalla")%>' runat="server">Borrar</asp:LinkButton>
