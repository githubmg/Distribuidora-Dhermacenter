<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/ContableWeb.Master" CodeBehind="frmTipoTarjetaEdit.aspx.vb" Inherits="ContableWeb.frmTipoTarjetaEdit" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentTitulo" runat="server">
Información del Tipo de Tarjeta
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="contentCuerpo" runat="server">

<div class="contenttitle"><h2 class="form"><span>Tipo de Tarjeta</span></h2></div>
<br />
<form runat="server" id="frmTipoTarjetaEdit" class="stdform" action="" method="post">
