<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/ContableWeb.Master" CodeBehind="frmEmpresaEdit.aspx.vb" Inherits="ContableWeb.frmEmpresaEdit" %>
...
<br />
<form runat="server" id="frmEmpresaEdit" class="stdform" action="" method="post">
