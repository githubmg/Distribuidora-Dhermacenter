...
Public Class frmViewer
    ...
    Private Sub ImprimirValoresCedidos()
        ...
        End If
        response = System.Web.HttpContext.Current.Response
        Dim rds1 As ReportDataSource = New ReportDataSource("DSContableWeb", Sistema.VistaValoresCedidos(desde, hasta))
    ...
    Private Sub ImprimirValoresCedidosExcel()
        ...
        End If
        If Not Me.Request.QueryString("hasta") Is Nothing Then
            desde = Me.Request.QueryString("hasta").ToString()
        End If
        Dim response As System.Web.HttpResponse
        Dim reportViewer1 As ReportViewer = New ReportViewer()
        Dim rds As ReportDataSource = New ReportDataSource("DSContableWeb", Sistema.VistaValoresCedidos(desde, hasta))
        response = System.Web.HttpContext.Current.Response
